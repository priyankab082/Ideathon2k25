  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
      ...
      <div className="bg-blue-100 p-6 rounded shadow-md">
        ...
        <Link to="/interview-setup" className="bg-black hover:bg-gray-800 text-white font-bold py-2 px-4 rounded w-full">
          Start Interview
        </Link>
      </div>
      ...
      <div className="bg-green-100 p-6 rounded shadow-md">
        ...
        <Link to="/profile" className="bg-white hover:bg-gray-100 text-gray-800 font-semibold py-2 px-4 rounded w-full border border-gray-400">
          Manage Profile
        </Link>
      </div>
